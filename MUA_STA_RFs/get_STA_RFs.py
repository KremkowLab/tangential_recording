...
class get_STA:
    def __init__(self, stimulus, spiketimes, frametimes, lags=np.arange(-5,5), save_dir=""):
    ...
    def _get_info(self):
        ...
        self.ft_bins = np.append(self.frametimes, self.frametimes[-1] + self.frame_duration_avg)
    ...
    def plot(self, subplots_rc=(20,20), fig_fname="STA_RFs.png", fig_size_pix=None):
        ...
        fig.subplots_adjust(wspace=0.1, hspace=0.2, top=0.99, bottom=0.01, left=0.002, right=0.998)
        ...
        for i in range(nrows*ncols):
            ...
            if i < self.n_tot_chs:
                ...
                ax.set_title('ch {}'.format(self.all_channels[i]), fontsize=10, y=.95)
